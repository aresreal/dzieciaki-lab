(function () {
  ...
  var phrases = [
    ...
    ['Zaczynam tam, gdzie jestem.', 'Nie tam, gdzie miałem być.'],
    ['Jedna rzecz na raz.', 'Reszta spokojnie poczeka.'],
    ['Mogę zrobić mały kawałek.', 'Nie muszę kończyć wszystkiego od razu.'],
    ['Najtrudniejszy bywa początek.', 'Potem już jest krok po kroku.'],
    ['Mój plan może się zmienić.', 'To nadal jest dobry plan.'],
    ['Jeśli zapomnę.', 'Mogę po prostu wrócić.'],
    ['Dzisiaj ćwiczę zaczynanie.', 'Nie bycie idealnym.'],
    ['Najpierw oddech.', 'Potem następna rzecz.'],
    ['Każde zadanie ma koniec.', 'Nawet jeśli teraz go nie widzę.'],
    ['Mogę zrobić to po swojemu.', 'Byle krok do przodu.'],
    ['Krótka przerwa może pomóc.', 'Wracam, kiedy będę gotowy.'],
    ['Nie muszę mieć ochoty.', 'Mogę zacząć od malutkiego kroku.'],
    ['Dwie minuty też się liczą.', 'Czasem od nich zaczyna się wszystko.'],
    ['Mój mózg lubi podpowiedzi.', 'Dlatego mam ten plan.'],
    ['Jeśli coś jest za duże.', 'Dzielę to na mniejsze kawałki.'],
    ['Nie porównuję swojego środka.', 'Do czyjegoś końca.'],
    ['Mam dziś swoją energię.', 'Planuję właśnie na nią.'],
    ['Najważniejsze nie jest tempo.', 'Tylko kierunek.'],
    ['Mogę zacząć niedoskonale.', 'To wciąż jest początek.'],
    ['Jedno zadanie mniej.', 'Jedna rzecz bliżej zabawy.'],
    ['Odhaczenie nie musi być wielkie.', 'Ma tylko być moje.'],
    ['Gdy się rozproszę.', 'Wracam bez złości na siebie.'],
    ['Nie wszystko jest pilne.', 'Wybieram to, co teraz ważne.'],
    ['Mój plan nie wydaje rozkazów.', 'On pokazuje drogę.'],
    ['Mogę poprosić o przypomnienie.', 'To sprytne, nie słabe.'],
    ['Zaczynam od jednej linijki.', 'Nie od całej listy.'],
    ['Dziś też mogę sobie pomóc.', 'Choćby odrobinę.'],
    ['Nie muszę walczyć z czasem.', 'Mogę działać razem z nim.'],
    ['Mały porządek.', 'Robi trochę miejsca w głowie.'],
    ['Najpierw to, co krótkie.', 'Potem zobaczymy.'],
    ['Mogę włączyć muzykę.', 'I zrobić pierwszy krok w rytmie.'],
    ['Woda, oddech, mały ruch.', 'A potem wracam do planu.'],
    ['Trudne nie znaczy niemożliwe.', 'Znaczy: potrzebuję mniejszego kroku.'],
    ['Nie zepsułem dnia.', 'Mogę zacząć od tej chwili.'],
    ['Poranek nie wyszedł?', 'Popołudnie ma własny start.'],
    ['Jedna rzecz zrobiona.', 'To więcej niż zero rzeczy.'],
    ['Mogę wybrać kolejność.', 'Plan jest mój.'],
    ['Jeśli utknę na długo.', 'Zmniejszam zadanie.'],
    ['Moja uwaga czasem wędruje.', 'Mogę ją łagodnie zaprosić z powrotem.'],
    ['Dziś nie muszę być superbohaterem.', 'Wystarczy, że będę sobą.'],
    ['Plan mówi: co dalej.', 'Ja decyduję: jak.'],
    ['Najpierw obowiązek.', 'Potem turbo frajda.'],
    ['Gotowe jest lepsze.', 'Niż idealne tylko w wyobraźni.'],
    ['Krok, odhaczenie, uśmiech.', 'I lecimy dalej.'],
    ['Nawet żółw dociera do celu.', 'Zwłaszcza z dobrą listą.'],
    ['Dziś mój plan jest pomocnikiem.', 'Nie bossem ostatniego poziomu.'],
    ['Mogę zrobić pauzę.', 'Nie muszę robić kapitulacji.'],
    ['Każdy dzień ma przycisk restart.', 'Właśnie go naciskam.'],
    ['Nie muszę ogarniać całego świata.', 'Wystarczy mój następny krok.']
  ];
